...
{
    class DexLookInstructionCommand : SRInstructionCommandBase
    {
        ...
        protected override CommandResult ProcessXmppMessage(string message)
        {
            ...
            */
            ...
            CommandResult result = CreateOutput(new TextOutput(Verbosity, message), Commands.CommandState.Finished);
            ...
            if (Parameters.Count == 1)
            {
                ...
                catch (Exception)
                {
                    ...
                    else
                    {
                        ...
                        {
                            baseRes.Error = new TextOutput(Commands.Verbosity.Critical, errorMsg);
                        }
